...
target="Adele-Someone_Like_You.mono-sr41000-ss16.raw"
sox $source -c 1 -r 41000 --bits 16 $target

source="Burning_Inside.mp3"
target="Burning_Inside.mono-sr41000-ss16.raw"
sox $source -c 1 -r 41000 --bits 16 $target

source="Christopher_Cross-Sailing.mp3"
target="Christopher_Cross-Sailing.mono-sr41000-ss16.raw"
sox $source -c 1 -r 41000 --bits 16 $target

source="Deicide-Kill_the_Christian.mp3"
target="Deicide-Kill_the_Christian.mono-sr41000-ss16.raw"
sox $source -c 1 -r 41000 --bits 16 $target

source="Disturbed-Down_With_The_Sickness.mp3"
target="Disturbed-Down_With_The_Sickness.mono-sr41000-ss16.raw"
sox $source -c 1 -r 41000 --bits 16 $target

#ffmpeg -i James_Blunt-Youre_Beautiful.m4a James_Blunt-Youre_Beautiful.mp3
source="James_Blunt-Youre_Beautiful.mp3"
target="James_Blunt-Youre_Beautiful.mono-sr41000-ss16.raw"
sox $source -c 1 -r 41000 --bits 16 $target

source="John_Lennon-Imagine.mp3"
target="John_Lennon-Imagine.mono-sr41000-ss16.raw"
sox $source -c 1 -r 41000 --bits 16 $target

#ffmpeg -i Ministry-Primitive_Future.m4a Ministry-Primitive_Future.mp3
source="Ministry-Primitive_Future.mp3"
target="Ministry-Primitive_Future.mono-sr41000-ss16.raw"
sox $source -c 1 -r 41000 --bits 16 $target

source="Rhiana-Diamonds.mp3"
target="Rhiana-Diamonds.mono-sr41000-ss16.raw"
sox $source -c 1 -r 41000 --bits 16 $target

source="Sony_Hackers-you_are_an_idiot.mp3"
target="Sony_Hackers-you_are_an_idiot.mono-sr41000-ss16.raw"
sox $source -c 1 -r 41000 --bits 16 $target
